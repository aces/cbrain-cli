...
def show_data_provider(args):
    ...
    if data_provider_id:
        ...
        try:
            ...
            print(f"id: {provider_data.get('id', 'N/A')}\n"
        ...
        print("ID   Name                 Type                            Host              Online")
        print("---- -------------------- ------------------------------- ----------------- ------")
        for provider in data_providers_data:
            ...
            print(f"{provider_id:<4} {provider_name:<20} {provider_type:<31} {provider_host:<17} {provider_online}")
