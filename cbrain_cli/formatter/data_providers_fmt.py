...
def print_provider_details(provider_data, args):
    ...
    status_info = [
        ...
        {"field": "Allow File Owner Change", "value": str(provider_data.get('allow_file_owner_change', 'N/A'))},
        {"field": "Content Storage Shared Between Users", "value": str(provider_data.get('content_storage_shared_between_users', 'N/A'))}
    ]
...
def print_providers_list(providers_data, args):
    ...
    dynamic_table_print(formatted_providers, 
