...
def print_task_data(tasks_data, args):
    ...
    dynamic_table_print(formatted_tasks, 
...
def print_task_details(task_data, args):
    ...
    execution_info = [
        ...
        {"field": "Results Data Provider ID", "value": str(task_data.get('results_data_provider_id', 'N/A'))},
        {"field": "Cluster Workdir Size", "value": str(task_data.get('cluster_workdir_size', 'N/A'))},
        {"field": "Workdir Archived", "value": str(task_data.get('workdir_archived', 'N/A'))},
        {"field": "Workdir Archive File ID", "value": str(task_data.get('workdir_archive_userfile_id', 'N/A'))}
    ]
