...
def test_show_data_provider_id_none_raises():
    """Missing id raises CliValidationError instead of silently listing."""
    with pytest.raises(CliValidationError, match="Data provider ID is required"):
        show_data_provider(_args(id=None))
